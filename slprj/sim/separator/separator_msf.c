...
#define S_FUNCTION_NAME separator_msf
#endif
...
c41nudlbzzn * dw = ( c41nudlbzzn * ) ssGetDWork ( S , 0 ) ; nxzao5fumq *
localX = ( nxzao5fumq * ) ssGetContStates ( S ) ; kqy2anfp4d ( localX ) ; }
static void mdlReset ( SimStruct * S ) { c41nudlbzzn * dw = ( c41nudlbzzn * )
ssGetDWork ( S , 0 ) ; nxzao5fumq * localX = ( nxzao5fumq * ) ssGetContStates
( S ) ; hh0zv3vnpj ( localX ) ; } static void mdlPeriodicOutputUpdate (
SimStruct * S , int_T tid ) { c41nudlbzzn * dw = ( c41nudlbzzn * ) ssGetDWork
( S , 0 ) ; const real_T * i_ix31ebu4ek = ( real_T * ) ssGetInputPortSignal (
S , 0 ) ; const real_T * i_haneq3o4io = ( real_T * ) ssGetInputPortSignal ( S
, 1 ) ; const real_T * i_hlavj5risq = ( real_T * ) ssGetInputPortSignal ( S ,
2 ) ; real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ;
nxzao5fumq * localX = ( nxzao5fumq * ) ssGetContStates ( S ) ; if ( tid == 0
) { separator ( i_ix31ebu4ek , i_haneq3o4io , i_hlavj5risq , o_B_1_1 , & ( dw
-> rtb ) , localX ) ; k3cjbdd1yt ( ) ; } } static void mdlInitializeSizes (
...
; slmrInitializeIOPortDataVectors ( S , 3 , 1 ) ; if ( ! ssSetNumInputPorts (
S , 3 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) )
...
mr_separator_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_separator_MdlInfoRegFcn
( S , "separator" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( c41nudlbzzn ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { c41nudlbzzn * dw = (
c41nudlbzzn * ) ssGetDWork ( S , 0 ) ; nxzao5fumq * localX = ( nxzao5fumq * )
ssGetContStates ( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ;
ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } jzqzzecl54 ( S ,
...
* S , int_T tid ) { c41nudlbzzn * dw = ( c41nudlbzzn * ) ssGetDWork ( S , 0 )
; const real_T * i_ix31ebu4ek = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
const real_T * i_haneq3o4io = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
const real_T * i_hlavj5risq = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; nxzao5fumq
* localX = ( nxzao5fumq * ) ssGetContStates ( S ) ; if ( tid != CONSTANT_TID
&& tid != PARAMETER_TUNING_TID ) { separator ( i_ix31ebu4ek , i_haneq3o4io ,
i_hlavj5risq , o_B_1_1 , & ( dw -> rtb ) , localX ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { c41nudlbzzn * dw = (
c41nudlbzzn * ) ssGetDWork ( S , 0 ) ; k3cjbdd1yt ( ) ; return ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { c41nudlbzzn * dw = (
c41nudlbzzn * ) ssGetDWork ( S , 0 ) ; csm0mmxacm * localXdot = ( csm0mmxacm
* ) ssGetdX ( S ) ; ovog4bf2pr ( & ( dw -> rtb ) , localXdot ) ; } static
void mdlTerminate ( SimStruct * S ) { c41nudlbzzn * dw = ( c41nudlbzzn * )
ssGetDWork ( S , 0 ) ; mrx1rio5r0 ( & ( dw -> rtm ) ) ; return ; }
...
simStateFieldNames ) ; { const nxzao5fumq * localX = ( const nxzao5fumq * )
ssGetContStates ( S ) ; const size_t numBytes = sizeof ( nxzao5fumq ) ;
...
storedX ) ; } { mxArray * mdlrefDW = mr_separator_GetDWork ( ssGetDWork ( S ,
0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_separator_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 ,
...
nxzao5fumq * localX = ( nxzao5fumq * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( nxzao5fumq ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_separator_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0
