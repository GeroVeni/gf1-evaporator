...
#define S_FUNCTION_NAME heater_steam_jacket_msf
#endif
...
) { ge0idcd1lo2 * dw = ( ge0idcd1lo2 * ) ssGetDWork ( S , 0 ) ; const real_T
* i_k4wecm1htb = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T *
i_oeoxwxvg0c = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T *
i_ekfacnsvet = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; const real_T *
i_lprbi5vt5s = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; if ( tid == 0 ) { heater_steam_jacket (
i_k4wecm1htb , i_oeoxwxvg0c , i_ekfacnsvet , i_lprbi5vt5s , o_B_1_1 , o_B_1_2
, o_B_1_3 ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S
...
mr_heater_steam_jacket_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes (
...
mr_heater_steam_jacket_MdlInfoRegFcn ( S , "heater_steam_jacket" , & retVal )
; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( ge0idcd1lo2 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { ge0idcd1lo2 * dw = (
ge0idcd1lo2 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } isbpebjbbr
...
* S , int_T tid ) { ge0idcd1lo2 * dw = ( ge0idcd1lo2 * ) ssGetDWork ( S , 0 )
; const real_T * i_k4wecm1htb = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
const real_T * i_oeoxwxvg0c = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
const real_T * i_ekfacnsvet = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
const real_T * i_lprbi5vt5s = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ;
...
) { heater_steam_jacketTID1 ( ) ; } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) ||
ssIsMinorTimeStep ( S ) ) { heater_steam_jacket ( i_k4wecm1htb , i_oeoxwxvg0c
, i_ekfacnsvet , i_lprbi5vt5s , o_B_1_1 , o_B_1_2 , o_B_1_3 ) ; } } } static
void mdlTerminate ( SimStruct * S ) { ge0idcd1lo2 * dw = ( ge0idcd1lo2 * )
ssGetDWork ( S , 0 ) ; mfzqpukysc ( & ( dw -> rtm ) ) ; return ; }
...
simStateFieldNames ) ; { mxArray * mdlrefDW = mr_heater_steam_jacket_GetDWork
( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } {
mxArray * data = mr_heater_steam_jacket_GetSimStateDisallowedBlocks ( ) ;
...
mr_heater_steam_jacket_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber (
