...
MAKECMD         = /infra/linux-apps/matlab/matlabR2018b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = heater_steam_jacket
MODULES                 = heater_steam_jacket.c heater_steam_jacket_capi.c
MAKEFILE                = heater_steam_jacket.mk
MATLAB_ROOT             = /infra/linux-apps/matlab/matlabR2018b
ALT_MATLAB_ROOT         = /infra/linux-apps/matlab/matlabR2018b
MASTER_ANCHOR_DIR       = 
START_DIR               = /homes/jh2044/Documents/GF1/model
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
DEFINES_CUSTOM          = 
SYSTEM_LIBS             = -L"/infra/linux-apps/matlab/matlabR2018b/bin/glnxa64" -lfixedpoint -lmwmathutil -lmwipp -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil
...
MODELLIB                  = heater_steam_jacketlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/heater_steam_jacket \
