...
#define S_FUNCTION_NAME condenser_msf
#endif
...
) { cxyhsbe2vvs * dw = ( cxyhsbe2vvs * ) ssGetDWork ( S , 0 ) ; const real_T
* i_oagw3ghbgg = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T *
i_niqsx2up0n = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T *
i_kgi0guq2ln = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; if ( tid == 0 ) { condenser ( i_oagw3ghbgg
, i_niqsx2up0n , i_kgi0guq2ln , o_B_1_1 , o_B_1_2 , o_B_1_3 ) ; } } static
...
mr_condenser_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2 ) ;
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_condenser_MdlInfoRegFcn
( S , "condenser" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( cxyhsbe2vvs ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { cxyhsbe2vvs * dw = (
cxyhsbe2vvs * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } fi33gp4y13
...
* S , int_T tid ) { cxyhsbe2vvs * dw = ( cxyhsbe2vvs * ) ssGetDWork ( S , 0 )
; const real_T * i_oagw3ghbgg = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
const real_T * i_niqsx2up0n = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
const real_T * i_kgi0guq2ln = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
...
) { condenserTID1 ( ) ; } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) ||
ssIsMinorTimeStep ( S ) ) { condenser ( i_oagw3ghbgg , i_niqsx2up0n ,
i_kgi0guq2ln , o_B_1_1 , o_B_1_2 , o_B_1_3 ) ; } } } static void mdlTerminate
( SimStruct * S ) { cxyhsbe2vvs * dw = ( cxyhsbe2vvs * ) ssGetDWork ( S , 0 )
; luyipqs2vc ( & ( dw -> rtm ) ) ; return ; }
...
simStateFieldNames ) ; { mxArray * mdlrefDW = mr_condenser_GetDWork (
ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } {
mxArray * data = mr_condenser_GetSimStateDisallowedBlocks ( ) ;
...
mr_condenser_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 ,
